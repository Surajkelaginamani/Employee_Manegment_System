...
const Accepct = ({ task }) => {
  return (
    <div>
        ...
        <div className='bg-blue-600 flex-shrink-0 w-[300px] h-full rounded-lg'>
            ...
            <div className='p-4 flex justify-between'>
                ...
                <button className=' bg-red-500 px-4 py-2 rounded-lg'>Failed Task</button>   
        </div>
    </div>
    </div>
